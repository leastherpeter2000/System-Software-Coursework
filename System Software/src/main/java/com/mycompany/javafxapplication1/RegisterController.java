...
public class RegisterController {
    ...
    /// 
    /// Select a file and Open Resource File
    ///
    ...
    /// 
    /// Register form for users, user need put the password and username
    ///
    ...
    private void registerBtnHandler(ActionEvent event) {
        ...
        try {
            ...
            DB myObj = new DB();
            if (passPasswordField.getText().equals(PassPasswordField.getText())) {
                ...
                Scene scene = new Scene(root, 640, 480);
                secondaryStage.setScene(scene);
                secondaryStage.setTitle("New User Register");
            }
            secondaryStage.show();
            primaryStage.close();
    ...
    @FXML
    private void BtnHandlerbackLogin(ActionEvent event) {
        Stage secondaryStage = new Stage();
